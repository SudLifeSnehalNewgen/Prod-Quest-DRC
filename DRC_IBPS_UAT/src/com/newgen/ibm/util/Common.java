...
public class Common{
    ...
    public void reconnectToWorkflow() {
        try {
        	...
        	elog.WriteErrorData("Exception "+ex.toString(), DRCWebservice_UtilityHelper.ErrorLogPath, "ErrorLog");
        ...
        try {
            ...
            //writeORnotLog(ex.toString());
        	elog.WriteErrorData("Exception occured while reconnecting to WorkFlow...."+ex.toString(), DRCWebservice_UtilityHelper.ErrorLogPath, "ErrorLog");
        }
    }
