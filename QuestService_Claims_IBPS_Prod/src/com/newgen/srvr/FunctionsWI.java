...
public class FunctionsWI {
    ...
    public String serverIP = QuestService_UtilityHelper.jtsIP;
    public int serverPort = QuestService_UtilityHelper.jtsPort;
...
public boolean connectToServer() {
  ...
  public String execute(String inXml) {
      try 
      {
    	  ...
    	  sJTSIP=QuestService_UtilityHelper.jtsIP;
    	  sJTSPort=QuestService_UtilityHelper.jtsPort;
		...
		if(this.xmlParser.getValueOf("Status").equals("-50146"))
		{
			...
			inXml = StrFirst+QuestService_UtilityHelper.sessionID+StrLast;
		...
		if(this.xmlParser.getValueOf("MainCode").equals("11") && this.xmlParser.getValueOf("TypeOfError").equals("Invalid Session"))
		{
			...
			//xmlParser.setInputXML(str);
			//SignImageDownloadUtilityHelper.sessionID=xmlParser.getValueOf("SessionId");
			System.out.println("Now SignImageDownloadUtilityHelper.sessionID"+QuestService_UtilityHelper.sessionID);
			String StrFirst=inXml.substring(0,inXml.indexOf("<SessionId>")+11);
			String StrLast=inXml.substring(inXml.indexOf("</SessionId>"));
    ...
    public String connectToWorkFlow(String forceful) {
        ...
        try {   
        	...
        	System.out.println("iiiiiiiiiiiiipppppppppppppppp"+sJTSIP+"POOOOOOOOOORRRRRRRRRRRRTTTTTTTTTTTttttttt"+sJTSPort+"ConnectTo workflow++++"+QuestService_UtilityHelper.cabinetName+"==AND=="+QuestService_UtilityHelper.userName+"==AND=="+QuestService_UtilityHelper.userPassword+"==AND=="+forceful);
            xmlInput = XMLGen.get_WMConnect_Input(QuestService_UtilityHelper.
                                                  cabinetName, QuestService_UtilityHelper.userName,
                                                  QuestService_UtilityHelper.userPassword, forceful);
            ...
            if (i == 0) {
            	...
            	QuestService_UtilityHelper.sessionID = xmlParser.getValueOf("SessionID");
            	QuestService_UtilityHelper.userID = xmlParser.getValueOf("ID");
            	System.out.println("After Setting sessionID :: "+QuestService_UtilityHelper.sessionID);
            ...
            elog.WriteErrorData("Exception occured while connecting to WorkFlow...."+e, QuestService_UtilityHelper.ErrorLogPath, "ErrorLog");
            e.printStackTrace();
        }
    ...
    public void disconnectFromWorkFlow() {
        String str_inxml = XMLGen.get_WMDisConnect_Input(QuestService_UtilityHelper.cabinetName,
        		QuestService_UtilityHelper.sessionID);
