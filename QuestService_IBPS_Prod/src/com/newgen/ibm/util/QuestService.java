...
public class QuestService implements Runnable 
{
    ...
    long startTime;
    Date startDate;
    String jsonInput="";//added on 23-11-2023 as input setting wrongly
    ...
    public void readINI() 
    {
        try 
        {
            ...
            System.getProperty("file.separator") + "Quest_WebService.ini"));
    ...
    public String fetchProductDetails(String processInstanceID)
    {
        ...
        try
        {
            ...
            inputXML_query = XMLGen.WFSelectTest_new(QuestService_UtilityHelper.cabinetName,QuestService_UtilityHelper.sessionID, query, "3");
            ...
            if (!(processInstanceID.equals("") || workItemID.equals(""))) 
            {
                ...
                if (mainCode.equals("0")) 
                {
                    ...
                    if (mainCode.equals("0")) 
                    {
                        ...
                        //if and else condition added by Ashwini on 10-02-2022
                        if(attributes.contains("</CONTRACT_POLICY_NUMBER>"))
                        {
                        ...
                        log.WriteSuccessLog("Inputxml======================Procedure GET_IIB_INPUT_DATA======================"+Inputxml,"SuccessLog");
                        String outXml = objWF.execute(Inputxml);
                        System.out.println("outXml======================"+outXml);
                        log.WriteSuccessLog("outXml==========GET_IIB_INPUT_DATA============"+outXml,"SuccessLog");
                        xmlParser.setInputXML(outXml);
                        String maincd = xmlParser.getValueOf("Status");
                        maincd = maincd+"|a";
                        System.out.println("maincd======================"+maincd);
                        log.WriteSuccessLog("maincd======================"+maincd,"SuccessLog");
                        ...
                        //}//commented on 23-11-2023 as input setting wrongly
                        /*String jsonInput ="{\n" +
                        "  \"Policy_Number\": \"01252226\",\n" +
                        "  \"Proposal_Number\": \"13077522\",\n" +
                        "  \"Query_Type\": \"1\",\n" +
                        "  \"DoP_DoC\": \"2014-03-27\",\n" +
                        "  \"Sum_Assured\": \"300000\",\n" +
                        "  \"LA_First_Name\": \"Sakunthala\",\n" +
                        "  \"LA_Middle_Name\": \"\",\n" +
                        "  \"LA_Last_Name\": \"\",\n" +
                        "  \"LA_DoB\": \"1976-04-06\",\n" +
                        "  \"LA_Gender\": \"F\",\n" +
                        "  \"LA_Current_Address\": \"VillBaniyaparPostSultanpurMauUttarPradesh\",\n" +
                        "  \"LA_Permanent_Address\": \"VillBaniyaparPostSultanpurMauUttarPradesh\",\n" +
                        "  \"LA_Pin_Code\": \"275303\",\n" +
                        "  \"LA_PAN\": \"ACVPY3160E\",\n" +
                        "  \"LA_Aadhar\": \"623137319763\",\n" +
                        "  \"LA_Ckyc\": \"\",\n" +
                        "  \"LA_Passport\": \"\",\n" +
                        "  \"LA_DL\": \"\",\n" +
                        "  \"LA_Voter_Id\": \"\",\n" +
                        "  \"LA_Phone_Number_1\": \"9450588010\",\n" +
                        "  \"LA_Phone_Number_2\": \"9450588010\",\n" +
                        "  \"LA_Email_1\": \"vy250803@gmail.com\",\n" +
                        "  \"LA_Email_2\": \"\",\n" +
                        "  \"Proposer_First_Name\": \"\",\n" +
                        ...
                        "  \"Proposer_DL\": \"\",\n" +
                        "  \"Proposer_Voter_Id\": \"\",\n" +
                        "  \"Proposer_Phone_Number_1\": \"\",\n" +
                        "  \"Proposer_Phone_Number_2\": \"\",\n" +
                        "  \"Proposer_Email_1\": \"\",\n" +
                        "  \"Proposer_Email_2\": \"\",\n" +
                        "  \"Date_of_Death\": \"\",\n" +
                        "  \"Nominee_First_Name\": \"Sadhana\",\n" +
                        "  \"Nominee_Last_Name\": \"Yadav\",\n" +
                        "  \"Nominee_Gender\": \"F\",\n" +
                        "  \"Nominee_DoB\": \"\",\n" +
                        ...
                        "  \"Nominee_Email\": \"\",\n" +
                        "  \"Intermediary_First_Name\": \"Union Bank of India\",\n" +
                        "  \"Intermediary_Middle_Name\": \"\",\n" +
                        "  \"Intermediary_Last_Name\": \"\",\n" +
                        "  \"Intermediary_DoB\": \"\",\n" +
                        "  \"Intermediary_PAN\": \"ACNPD1936H\",\n" +
                        "  \"Intermediary_Aadhar\": \"\",\n" +
                        "  \"Intermediary_Passport\": \"\",\n" +
                        "  \"Intermediary_DL\": \"\",\n" +
                        "  \"Intermediary_Voter_Id\": \"\",\n" +
                        ...
                        "}";
                        }//added on 23-11-2023 as input setting wrongly
                        /*String jsonInput ="{\n" +
"  \"Policy_Number\": \"01357305\",\n" +
"  \"Proposal_Number\": \"13449410\",\n" +
"  \"Query_Type\": \"1\",\n" +
"  \"DoP_DoC\": \"2019-10-30\",\n" +
"  \"Sum_Assured\": 5000000.00,\n" +
"  \"LA_First_Name\": \"Krishnamurthy D\",\n" +
"  \"LA_Middle_Name\": \"\",\n" +
"  \"LA_Last_Name\": \"Krishnamurthy D\",\n" +
"  \"LA_DoB\": \"1967-09-09\",\n" +
"  \"LA_Gender\": \"M\",\n" +
"  \"LA_Current_Address\": \"No4691010GirijaMeghnagar4thCrossPadilPostMangloreAlpeVillageMangloreKarnataka\",\n" +
"  \"LA_Permanent_Address\": \"No4691010GirijaMeghnagar4thCrossPadilPostMangloreAlpeVillageMangloreKarnataka\",\n" +
"  \"LA_Pin_Code\": \"575007\",\n" +
"  \"LA_PAN\": \"AAAPM8538P\",\n" +
"  \"LA_Aadhar\": \"305438811881\",\n" +
"  \"LA_Ckyc\": \"\",\n" +
"  \"LA_Passport\": \"\",\n" +
"  \"LA_DL\": \"\",\n" +
"  \"LA_Voter_Id\": \"\",\n" +
"  \"LA_Phone_Number_1\": \"9449037100\",\n" +
"  \"LA_Phone_Number_2\": \"\",\n" +
"  \"LA_Email_1\": \"kmurthyd1967@gmail.com\",\n" +
"  \"LA_Email_2\": \"\",\n" +
"  \"Date_of_Death\": \"\"\n" +
"}";*/
                        ...
                        if(SOAPResponse_xml!=null && !SOAPResponse_xml.trim().equals(""))
                        {
                            ...
                            String code="";
                            if (!obj1.isNull("Code")){ //added by amit for handling null response 30-08-21
                            code = obj1.getString("Code");
                            }
                            String trnid ="";
                            if (!obj1.isNull("TransactionID")) {  //added by amit for handling null response 30-08-21
                            trnid = obj1.getString("TransactionID");
                             }
                            ...
                            else if(code.equalsIgnoreCase("1"))
                            {
                                ...
                                String inColumns = "BO_Error,QUEST_Error,QUEST_ERROR_CODE";
                                //String inWhere = "wi_name =" + k;
                            ...
                            else if(code.equalsIgnoreCase("2"))
                            {
                               ...
                               //UpdateWFInstTable(sColumnValue_WFinst,processInstanceID,workItemID);
                                //String inColumns = "BO_Error,QUEST_Error,QUEST_ERROR_CODE";
                                //String inWhere = "wi_name =" + k;
                                //String inValues = "'ValidationError'" + ",'" + response + "','2'";
                               UpdateExternalTable(inValues,processInstanceID,workItemID,inColumns);
                               //UpdateExternalTable(sColumnValue_ext_Error,processInstanceID,workItemID);
                            }
                            else if(code.equalsIgnoreCase("3"))
                            {
                               ...
                               String inColumns = "BO_Error,QUEST_ERROR_CODE,Decision_IIBFailure";
                                //String inWhere = "wi_name =" + k;
                                String inValues = "'QUEST_WS_ERROR','" + code + "','3','RE-TRY'";
	...
	String Product_Type="";
        try
        {   
            String query1 ="select Product_Code,ProductCode from NG_SUD_NBP_EXT_TABLE with (nolock) where CONTRACT_POLICY_NUMBER ='"+CONTRACT_POLICY_NUMBER+"'";
            inputXML_query1 = XMLGen.WFSelectTest_new(QuestService_UtilityHelper.cabinetName,QuestService_UtilityHelper.sessionID, query1, "2");
                   ...
                   String TagValGL2[] = null;
                    ...
                    for (int iCase = 0; iCase < TagValGL2.length; iCase++) 
                    {
                        ...
                        if(!resultGL2[0].toString().equalsIgnoreCase(""))
                        {
                            ...
                            ProductCode = resultGL2[1].toString();
                            log.WriteSuccessLog("Inside getProductTypeAgainstContractPolNo Product_Code:" +Product_Code ,"SuccessLog");
                            log.WriteSuccessLog("Inside getProductTypeAgainstContractPolNo ProductCode:" +Product_Code ,"SuccessLog");
                        }
                    }
	...
	try
        {   
            String query1 ="";
            if(Product_Code.trim().length()==3)
            query1 ="select IIB_Annexure_Code from NG_SUD_NBP_PRODUCT_MAS with (nolock) where descitem ='"+Product_Code+"'";
            else
            query1 ="select IIB_Annexure_Code from NG_SUD_NBP_PRODUCT_MAS with (nolock) where descitem ='"+ProductCode+"'";
            ...
            if (mainCode_query1.equals("0")) 
        {
               String TagValGL2[] = null;
                ...
                for (int iCase = 0; iCase < TagValGL2.length; iCase++) 
                {
                    ...
                    log.WriteSuccessLog("Inside getProductUINAgainstContractPolNo ProductCode:" +ProductCode ,"SuccessLog");
                    }
                }
	...
	try
        {   
            String query1 ="";
            if(Product_Code.trim().length()==3)
            query1 ="select IIB_UIN from NG_SUD_NBP_PRODUCT_MAS with (nolock) where descitem ='"+Product_Code+"'";
            else
            query1 ="select IIB_UIN from NG_SUD_NBP_PRODUCT_MAS with (nolock) where descitem ='"+ProductCode+"'";    
            inputXML_query1 = XMLGen.WFSelectTest_new(QuestService_UtilityHelper.cabinetName,QuestService_UtilityHelper.sessionID, query1, "1");
            outputXML_query1 = objWF.execute(inputXML_query1);
	...
	String anNUAL_INCOME_LA="";
        try
        {   
            String query1 ="select wi_name from NG_SUD_NBP_EXT_TABLE with (nolock) where CONTRACT_POLICY_NUMBER ='"+CONTRACT_POLICY_NUMBER+"'";
            inputXML_query1 = XMLGen.WFSelectTest_new(QuestService_UtilityHelper.cabinetName,QuestService_UtilityHelper.sessionID, query1, "1");
            outputXML_query1 = objWF.execute(inputXML_query1);
            xmlParser.setInputXML(outputXML_query1);
            ...
            if (mainCode_query1.equals("0")) 
        {
               String TagValGL2[] = null;
                ...
                for (int iCase = 0; iCase < TagValGL2.length; iCase++) 
                {
                    ...
                    if(!resultGL2[0].toString().equalsIgnoreCase(""))
                    {
                    wi_name = resultGL2[0].toString();
                    log.WriteSuccessLog("Inside getAnnualIncomeAgainstContractPolNo wi_name:" +wi_name ,"SuccessLog");
                    }
                }
	...
	try
        {   
            String query1 ="select anNUAL_INCOME_LA from NG_SUD_NBP_IND_DATA_ENTRY with (nolock) where wi_name ='"+wi_name+"'";
            inputXML_query1 = XMLGen.WFSelectTest_new(QuestService_UtilityHelper.cabinetName,QuestService_UtilityHelper.sessionID, query1, "1");
            outputXML_query1 = objWF.execute(inputXML_query1);
        ...
        if(anNUAL_INCOME_LA.equalsIgnoreCase("null")||anNUAL_INCOME_LA.equalsIgnoreCase("")||anNUAL_INCOME_LA.equals(null)||anNUAL_INCOME_LA.equals("null"))
        {
            log.WriteSuccessLog("Inside getAnnualIncomeAgainstContractPolNo.Annual income is null or blank.Setting it to 0","SuccessLog");
            anNUAL_INCOME_LA="0";
        }
    ...
    public String GenerateRandomNumber(String processInstanceID)
    {
        ...
        try
        {
            String query = "Select max(RandomNumber) from NG_SUD_NB_QUEST_OUTPUT with(nolock) where wi_name ='"+processInstanceID+"' and WI_ID='1'";
            //String query = "Select NOMINEE_RELATION_TO_LA from NG_SUD_NBP_NOMINEE_DTLS with(nolock) where wi_name ='NB-00000000264373-SUD'";
            inputXML_query = XMLGen.WFSelectTest_new(QuestService_UtilityHelper.cabinetName,QuestService_UtilityHelper.sessionID, query, "1");
            outputXML_query = objWF.execute(inputXML_query);
            xmlParser.setInputXML(outputXML_query);
    ...
    public void UpdateWI_ID_IN_QuestTable(String wi_name)
    {
        ...
        String mainCode;
        String queryToUpdateExtTable="UPDATE NG_SUD_NB_QUEST_OUTPUT SET WI_ID=(select max(WI_ID)+1 from NG_SUD_NB_QUEST_OUTPUT where WI_NAME='"+wi_name+"') WHERE WI_ID='1' and WI_NAME='"+wi_name+"'";
        ...
        if (mainCode.equals("0")) 
        {
                log.WriteSuccessLog("WI_ID Column Value updated into NG_SUD_NB_QUEST_OUTPUT Success...","SuccessLog");
                System.out.println("WI_ID Column Value updated into NG_SUD_NB_QUEST_OUTPUT Success...");
                
        }
        else
        {
                log.WriteSuccessLog("WI_ID Column Value updated into NG_SUD_NB_QUEST_OUTPUT Table Failed...","SuccessLog");
                System.out.println("WI_ID Column Value updated into NG_SUD_NB_QUEST_OUTPUT Table Failed...");
        }       
    }
    ...
    public void UpdateExternalTable(String values,String wiid,String workitemid,String columns)
    {
        ...
        inputXML_ext=WFUpdate_Input(QuestService_UtilityHelper.cabinetName,QuestService_UtilityHelper.sessionID,"2",EXT_TABLE,columns,values,where);
									/*MQUtilityHelper.cabinetName, sessionID,
									MQUtilityHelper.ProcessDefID,
									MQUtilityHelper.EXTTable, inColumns,
									inValues, inWhere);*/
        //inputXML_ext = XMLGen.IGSetData(QuestService_UtilityHelper.cabinetName,queryToUpdateExtTable);
        log.WriteSuccessLog("Update Core Status in Route Table input xml is ******* :"+inputXML_ext,"SuccessLog");
        System.out.println("Update Core Status in Route Table input xml is ******* :"+inputXML_ext);
